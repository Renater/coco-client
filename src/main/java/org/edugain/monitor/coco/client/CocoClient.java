...
@Component
@Configuration
@ConfigurationProperties(prefix = "application.clients.coco")
public class CocoClient {

	private static final Logger LOG = LoggerFactory.getLogger(CocoClient.class);
