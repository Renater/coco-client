 ...
 * @author arnoud
 */
public class CocoCustomInstantDeserializer<T extends Temporal> extends ThreeTenDateTimeDeserializerBase<T> {
	private static final long serialVersionUID = 1L;

	// @formatter:off
	private static final DateTimeFormatter COCO_OFFSET_DATE_TIME = new DateTimeFormatterBuilder()
...
//	private static final DateTimeFormatter CUSTOM_OFFSET_DATE_TIME = DateTimeFormatter.ISO_OFFSET_DATE_TIME;
	private static final DateTimeFormatter CUSTOM_OFFSET_DATE_TIME = COCO_OFFSET_DATE_TIME;
	
	private static final DateTimeFormatter COCO_ZONED_DATE_TIME = new DateTimeFormatterBuilder()
	...
	public static final CocoCustomInstantDeserializer<Instant> INSTANT = new CocoCustomInstantDeserializer<Instant>(
	...
	public static final CocoCustomInstantDeserializer<OffsetDateTime> OFFSET_DATE_TIME = new CocoCustomInstantDeserializer<OffsetDateTime>(
	...
	public static final CocoCustomInstantDeserializer<ZonedDateTime> ZONED_DATE_TIME = new CocoCustomInstantDeserializer<ZonedDateTime>(
			ZonedDateTime.class, COCO_ZONED_DATE_TIME, new Function<TemporalAccessor, ZonedDateTime>() {
				@Override
	...
	protected CocoCustomInstantDeserializer(Class<T> supportedType, DateTimeFormatter parser,
	...
	protected CocoCustomInstantDeserializer(CocoCustomInstantDeserializer<T> base, DateTimeFormatter f) {
	...
	protected JsonDeserializer<T> withDateFormat(DateTimeFormatter dtf) {
		...
		return new CocoCustomInstantDeserializer<T>(this, dtf);
	}
